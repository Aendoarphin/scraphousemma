		...
		<>
			<div className="bg-dark-grey rounded-t-md h-min p-8 flex gap-8 max-w-full overflow-hidden flex-col">
				<div className="justify-around flex gap-4">
					...
					/>
					<div className="flex flex-col border-y-[1px] py-1">
			...
			<div className="hover:-translate-y-1 active:contrast-50 rounded-b-md mt-1 bg-main p-2 flex mx-auto max-w-full overflow-hidden">
        <h1 className="m-auto font-extrabold">News</h1>
      </div>
		</>
	);
};
