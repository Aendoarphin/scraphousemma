            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-4">
                <FontAwesomeIcon
                  ...
                  className="text-4xl"
                />
                <p>Stay up to date with the latest headlines from multiple sources</p>
              </div>
              <div className="flex flex-col gap-4">
                <FontAwesomeIcon
                  icon={faTrophy}
                  className="text-4xl"
                />
                <p>Explore the fighter directory and view the latest rankings</p>
              </div>
              <div className="flex flex-col gap-4">
                <FontAwesomeIcon
                  icon={faCalendar}
      ...
      <div className="border border-main h-screen p-8 text-center flex flex-wrap justify-center gap-6">
        <div className="border border-[green] size-full flex flex-col justify-around">
          <div className="flex flex-col gap-8">
            ...
            <Image alt="ufc logo" height={100} src={ufc} className="m-auto dark:invert-0 invert"/>
            <Image alt="pfl logo" height={100} src={pfl} className="m-auto  dark:invert-0 invert"/>
            <Image alt="bellator logo" height={100} src={bellator} className="m-auto  dark:invert-0 invert"/>
            <Image alt="onefc logo" height={100} src={onefc} className="m-auto  dark:invert-0 invert"/>
          </div>
        </div>
      </div>
    </>
